"""
Smoke test for sentiment score-based finetuning (DPO variant).
Runs tiny training/eval loops on a couple of batches to verify the pipeline.
"""
...
def main():
    ...
    print(f"[Smoke DPO] Using device: {device}")
    print("[Smoke DPO] Loading backbones...")
    ...
    # Point to same data but the runner will consume only small batches via batch_size/epochs
